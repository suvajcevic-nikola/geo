...
class MapView extends (0, _NativeBridgeComponent.default)(_react.default.PureComponent, NATIVE_MODULE_NAME) {
  ...
  _onCameraChanged(e) {
    ...
    (_this$props$onCameraC = (_this$props = this.props).onCameraChanged) === null || _this$props$onCameraC === void 0 ? void 0 : _this$props$onCameraC.call(_this$props, e.nativeEvent.payload);
  }
  _onChange(e) {
    const {
